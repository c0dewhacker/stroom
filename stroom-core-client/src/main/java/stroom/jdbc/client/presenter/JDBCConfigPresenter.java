...
package stroom.jdbc.client.presenter;
...
public class JDBCConfigPresenter extends DocumentEditTabPresenter<LinkTabPanelView, JDBCConfigDoc> {
    ...
    @Inject
    public JDBCConfigPresenter(final EventBus eventBus,
        ...
        addTab(CONFIG, new AbstractTabProvider<JDBCConfigDoc, EditorPresenter>(eventBus) {
            @Override
            ...
            @Override
            public JDBCConfigDoc onWrite(final EditorPresenter presenter, final JDBCConfigDoc document) {
                document.setData(presenter.getText());
                return document;
            }
        });
        addTab(DOCUMENTATION, new MarkdownTabProvider<JDBCConfigDoc>(eventBus, markdownEditPresenterProvider) {
            @Override
            ...
            @Override
            public JDBCConfigDoc onWrite(final MarkdownEditPresenter presenter,
                                          final JDBCConfigDoc document) {
    ...
    @Override
    public void onRead(final DocRef docRef, final JDBCConfigDoc doc, final boolean readOnly) {
